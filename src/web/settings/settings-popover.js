...
export function apiKeyPlaceholder(presetId) {
  if (presetId === "openrouter") return "sk-or-v1-…";
  return presetId === "custom" ? "Optional API key" : "API key";
}
